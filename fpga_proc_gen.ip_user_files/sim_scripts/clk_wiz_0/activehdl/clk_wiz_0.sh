...
#
# Script generated by Vivado on Wed Apr 24 22:53:08 -0500 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/benap/github/fpga_proc_gen/fpga_proc_gen.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
